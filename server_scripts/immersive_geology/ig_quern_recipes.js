...
ServerEvents.recipes(event => {
  // --- Remove any conflicting recipe(s)
  event.remove({ id: 'tfg:quern/copper_crushed_ore_from_poor_raw_ore' });

  // --- Verified working example
  event.recipes.tfc.quern(
    'immersivegeology:dirty_crushed_ore_cuprite',
    'immersivegeology:normal_ore_cuprite'
  ).id('immersivegeology:quern/dirty_crushed_ore_cuprite');

  // --- IG-exclusive ores (all explicit, same structure)
